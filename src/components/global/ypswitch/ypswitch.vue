...
<template>
  ...
  <div class="relative h-[22px] w-[50px] rounded-full overflow-hidden duration-300 text-sm cursor-pointer" :class="{'bg-blue-600 text-white':modelValue,'bg-gray-400':!modelValue}" @click="toogle"
    v-if="isload">
