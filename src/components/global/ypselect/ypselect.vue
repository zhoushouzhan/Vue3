<template>
    <div class="group inline-block relative cursor-pointer w-full min-w-max" ref="select" @click="show=true" @mouseleave="show=false">
      ...
      <div class="overflow-hidden w-full max-h-0 duration-300 flex flex-col text-gray-800 bg-white rounded-sm absolute z-30  top-[31px] border-t border-l border-r rounded" ref="optionsNode" :class="{'max-h-[300px] overflow-y-auto':show}"
        v-show="show">
